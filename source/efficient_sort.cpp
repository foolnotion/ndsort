...
auto efficient_binary_sorter::sort_impl(detail::flat_fitness const& ff, double eps) const -> fronts
{
    return ens_sort_impl<ens_strategy::binary>(ff, eps);
}

auto efficient_sequential_sorter::sort_impl(detail::flat_fitness const& ff, double eps) const -> fronts
{
